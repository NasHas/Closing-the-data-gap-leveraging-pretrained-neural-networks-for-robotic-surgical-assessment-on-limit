...
for train_index, val_index in kf.split(all_data):
    ...
    # Build the model
    model = load_model() # INSERT MODEL HERE IF YOU WANT TO RETRAIN ALL LAYERS OF THE PRETRAINED MODEL

    # for layer in model.layers: #UNCOMMENT THESE LINES IF YOU ONLY WANT TO RETRAIN YOU DENSE AND LSTM LAYERS.
    #     if isinstance(layer, keras.layers.Dense) or isinstance(layer, keras.layers.LSTM):
    #         layer.trainable = True #Dense og LSTM bliver trænet. Resten holdes frosset.
    #     else:
